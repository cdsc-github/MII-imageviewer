...
public class FlipVerticalEdit extends ComponentUndoableEdit {

	boolean flipState=false;
	ImagePanel source=null;

	public FlipVerticalEdit(ImagePanel source, boolean flipState) {this.source=source; this.flipState=flipState;}
	...
	public void undo() throws CannotUndoException {
		...
		source.repaint();
		source.fireGroupPropertyChange(new String[] {RenderingProperties.VERTICAL_FLIP},new Object[] {new Boolean(flipState)});
	}
